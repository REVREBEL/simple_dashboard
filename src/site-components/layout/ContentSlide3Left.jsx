...
export function ContentSlide3Left({
  content2 = "",
  responsiveHeadlineHeadlineSizeVariants = "base",
  slotHeadline,
  slotLabel,
  slotLabel2,
  subTitle = "We use predictive analytics and booking curve data to optimize availability and shift inventory where it matters most.",
  tagIcon3IconIconSizeVariants = "Extra Small",
  tagIcon3TagColor = "Color 2",
  tagIcon3TagTagBackgroundClickable = "Solid",
  tagIcon3TagTagSize = "Small",
  tagIcon4IconIconSizeVariants = "Extra Small",
  tagIcon4TagColor = "Color 8",
  tagIcon4TagTagBackgroundClickable = "Solid",
  tagIcon4TagTagSize = "Small",
}) {
  ...
  return (
    ...
    >
      <Block className={"strategy-card add-border_right"} tag={"div"}>
        <VFlex className={"padding_xs padding-right_sm"} tag={"div"}>
          <Block
            className={"strategy-card_section is-middle is-layout-3"}
            tag={"div"}
          >
            <Block className={"strategy-card_body is-layout-3"} tag={"div"}>
              <Block
                className={"tags-group is-layout-3 flex-align_stretch"}
                tag={"div"}
              >
              ...
              <Block
                className={
                  "headline-wrapper flex-align_left margin-block_none is-layout-3"
                }
                tag={"div"}
              >
                {slotHeadline}
          ...
          <Block
            className={"strategy-card_section is-bottom is-layout-3"}
            tag={"div"}
          >
            <Block className={"content-wrapper padding-top_xxs"} tag={"div"}>
