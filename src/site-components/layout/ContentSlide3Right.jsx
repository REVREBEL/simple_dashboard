...
export function ContentSlide3Right({
  content2 = "",
  slotHeadline,
  slotLabel,
  slotLabel2,
  subTitle = "We track the things that matter -- key metrics that drive success, ensuring you have the insights needed to make informed decisions. ",
  tagIcon2IconIconSizeVariants = "Extra Small",
  tagIcon2TagColor = "Color 8",
  tagIcon2TagTagBackgroundClickable = "Solid",
  tagIcon2TagTagSize = "Small",
  tagIconIconIconSizeVariants = "Extra Small",
  tagIconTagColor = "Color 2",
  tagIconTagTagBackgroundClickable = "Solid",
  tagIconTagTagSize = "Small",
}) {
  ...
  return (
    ...
    >
      <Block className={"strategy-card add-border_left"} tag={"div"}>
        <VFlex className={"padding_xs padding-left_sm"} tag={"div"}>
          <Block
          ...
          >
            <Block className={"strategy-card_body is-layout-3"} tag={"div"}>
              <Block
                ...
                tag={"div"}
              >
                <Block className={"label-wrapper grid_2-col"} tag={"div"}>
                  {slotLabel}
                </Block>
