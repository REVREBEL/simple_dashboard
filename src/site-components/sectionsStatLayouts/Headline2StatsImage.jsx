...
export function Headline2StatsImage({
  headlineMainHeadline = "Seamless CRS migrations. Proven results.",
  headlineSubHeadlineText = "Experience effortless transitions to Synxis CRS—minimizing downtime, maximizing revenue, and setting your hotel up for immediate success.",
  image = "https://cdn.prod.website-files.com/6a09244ce43d4439301ce56f/6a09244ce43d4439301ceebd_f8c4eb24-5293-46bd-b73f-5950bcef20b0.avif",
  stat1StatDescriptionText = "Faster bookingsafterseamless migration",
  stat1StatHeadline = "42% efficiency gain",
  stat2StatDescriptionText = "Zero disruptions.100%operational continuity",
  stat2StatHeadlineText = "31+ Hotels Migrated",
}) {
  ...
  return (
    ...
    >
      <Section className={"component_size"} tag={"section"}>
        <Block className={"container-md"} tag={"div"}>
          <Grid className={"grid_2-col tablet_1-col gap-large"}>
            <Block
              className={
                "flex-vertical is_space-between gap-medium text-color-blue"
              }
              id={"w-node-_4edcea81-83ee-4bfe-a660-9a91ea9d88c8-ea9d88c5"}
              tag={"div"}
            >
              <Block className={"headline-wrapper"} tag={"div"}>
                <Block className={"eyebrow"} tag={"div"}>
                  {"CRS Migration"}
                </Block>
                <Heading
                  className={
                    "headline-base font-weight-bold headline-animated-block"
                  }
                  tag={"h2"}
                >
                  {headlineMainHeadline}
                </Heading>
                <Block className={"subheadline-xs"} tag={"div"}>
                  {headlineSubHeadlineText}
                </Block>
              </Block>
              <Grid
                className={"grid_2-col"}
                id={"w-node-_4edcea81-83ee-4bfe-a660-9a91ea9d88d0-ea9d88c5"}
              >
                <Block
                  className={"item-wrapper"}
                  id={"w-node-_4edcea81-83ee-4bfe-a660-9a91ea9d88d1-ea9d88c5"}
                  tag={"div"}
                >
                  <Block className={"headline-xs text-color-3"} tag={"div"}>
                    {stat1StatHeadline}
                  </Block>
                ...
                <Block
                  className={"item-wrapper"}
                  id={"w-node-_4edcea81-83ee-4bfe-a660-9a91ea9d88d6-ea9d88c5"}
                  tag={"div"}
                >
                  <Block className={"headline-xs text-color-3"} tag={"div"}>
                    {stat2StatHeadlineText}
                  </Block>
                  <Block className={"paragraph"} tag={"div"}>
            ...
            <Block className={"image-wrapper"} tag={"div"}>
              <Image
                alt={
                  "image of data analytics charts for a data analytics and business intelligence website"
                }
                className={"image_cover image-ratio_3x2"}
                data-aisg-image-id={"e108c68f-5e0f-4f86-9949-79527da47a35"}
                height={"483"}
                loading={"lazy"}
                src={image}
                width={"592"}
