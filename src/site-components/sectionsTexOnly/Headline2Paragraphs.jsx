...
export function Headline2Paragraphs({
  componentComponentVisibility = true,
  componentId = "",
  headlineHeadlineSizeVariants = "Level 3 Bigger",
  headlineHeadlineTag = "h2",
  optionsBackgroundTextColor = "Base",
  paragraphsBottomCallToAction = "Unlock new Revenue Without Adding Rooms",
  paragraphsParagraph1Text = "Brand Activation goes beyond logos and taglines — it's about creating real moments of connection between yourhotel and your ideal guest. In this category, we explore how hotels can bring their brand to life through experiences,storytelling, and campaign execution. From launching a new brand or refreshing an old one, to activating seasonal themes, partnerships, and in-market events, these articles are focused on practical ways to stand out.",
  paragraphsParagraph2Text = "From developing messaging for advertising campaigns tocoordinating promotions and creating impactful visuals,our team can provide comprehensive support through out the entire process. We understand the importance ofcreating an engaging brand experience, and we’ll work withyou every step of the way to ensure that your hotel’smessage is communicated effectively.",
  slot19,
}) {
    ...
    >
      <Block tag={"div"}>
        {componentComponentVisibility ? (
          <Block data-copilot={"true"} id={componentId} tag={"div"}>
            <Block className={"div-block-831"} tag={"div"}>
              <Heading
                className={"headline-sm text-color-cyan"}
                tag={headlineHeadlineTag}
              >
                {"Brand Activation"}
              </Heading>
              <Block className={"headline-wrapper flex-horizontal"} tag={"div"}>
                {slot19}
              </Block>
              <Block className={"grid_2-col gap-md"} tag={"div"}>
                <Block className={"column-left"} tag={"div"}>
                  <Paragraph className={"paragraph"}>
                    {paragraphsParagraph1Text}
                  </Paragraph>
                </Block>
                <Block className={"column-right"} tag={"div"}>
                  <Paragraph className={"paragraph"}>
                    {paragraphsParagraph2Text}
                  </Paragraph>
                </Block>
              </Block>
              <Block
                className={"text-wrapper text-align-left margin-top_sm"}
                id={"w-node-_0fe6f5c6-99c4-e472-f7ee-74687047fc54-6dde68ee"}
                tag={"div"}
              >
                <Block
                  className={"label-lg flex_align-left"}
                  id={"w-node-_0fe6f5c6-99c4-e472-f7ee-74687047fc55-6dde68ee"}
                  tag={"div"}
                >
                  {paragraphsBottomCallToAction}
                </Block>
              </Block>
            </Block>
          </Block>
