...
export function LargeContactForm({
  ...
  emailAddressFormText = "Fill the form or email usat",
  ...
  const _styleVariantMap = {
    ...
    Cyan: "w-variant-fd5ad05b-d29c-08de-2a84-27879c95f967",
  };
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <Block
                      className={`left-wrapper padding_xs margin-right_none padding-top_3rem width_100pct_mobile-l ${_activeStyleVariant}`}
                      id={
                        "w-node-_27ea9e2b-a7b7-9513-cc06-f7a48e6c4fb2-8e6c4fb0"
                      }
                      tag={"div"}
                    >
                      <Heading
                        ...
                        className={`headline-base padding-bottom_xs scroll-in-view_slide-left ${_activeStyleVariant}`}
                        tag={contactUsContactUsHeadlineTag}
                      >
                        {contactUsContactUsHeadline}
                      </Heading>
                      <Block
                        className={`contact_paragraph-wrapper ${_activeStyleVariant}`}
                        tag={"div"}
                      >
                        <Paragraph
                          // @ts-ignore - User-defined custom attribute(s)
                          clas={"text-align_center_mobile-l"}
                          className={`paragraph text-wrap_balance scroll-in-view_slide-left ${_activeStyleVariant}`}
                        >
                          {contactUsContactUsText}
                        </Paragraph>
                        <Block
                          className={`contact_text ${_activeStyleVariant}`}
                          tag={"div"}
                        >
                          <Paragraph
                            className={`paragraph ${_activeStyleVariant}`}
                          >
                            {emailAddressFormText}
                          </Paragraph>
                          <Link
                            button={false}
                            className={`email-us-link ${_activeStyleVariant}`}
                            options={emailAddressEmailAddressLink}
                          >
                            {emailAddressEmailAddressLink2}
                          </Link>
                        </Block>
                      </Block>
                      <Block
                        className={`divider margin-bottom_sm margin-top_sm bg-color-white ${_activeStyleVariant}`}
                        tag={"div"}
                      />
                      <Block
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            />
                            <Block
                              className={` padding-bottom_sm ${_activeStyleVariant}`}
                              tag={"div"}
                            >
                              <Block
                          ...
                          >
                            <Block
                              className={` form_link-wrapper flex-align_top ${_activeStyleVariant}`}
                              tag={"div"}
                            >
                              <HtmlEmbed
                    ...
                    <Block
                      className={`right-wrapper padding_xs width_100pct mobile-padding-top_adjustment ${_activeStyleVariant}`}
                      id={
                        "w-node-_27ea9e2b-a7b7-9513-cc06-f7a48e6c4fe3-8e6c4fb0"
                      }
                      tag={"div"}
                    >
                      <FormWrapper
                      ...
                      >
                        ...
                        >
                          <FormTextInput
                            ...
                            autoFocus={false}
                            className={`form_input is-light w-node-af1819be-0d2e-48b6-3364-e93038ecc1b1-8e6c4fb0 ${_activeStyleVariant}`}
                          ...
                          <FormTextInput
                            ...
                            autoFocus={false}
                            className={`form_input is-last-name is-light ${_activeStyleVariant}`}
                            data-name={"lastName"}
                            disabled={false}
                            id={"Last-Name"}
                            maxLength={256}
                          ...
                          <FormTextInput
                            ...
                            autoComplete={"email"}
                            autoFocus={false}
                            className={`form_input is-email-address is-light ${_activeStyleVariant}`}
                            data-name={"Email"}
                            disabled={false}
                            id={"Email-Address"}
                            maxLength={256}
                          ...
                          <FormTextInput
                            ...
                            autoFocus={false}
                            className={`form_input is-phone-number is-light ${_activeStyleVariant}`}
                            data-name={"tel"}
                            disabled={false}
                            id={"Phone-Number"}
                            maxLength={256}
                          ...
                          <FormTextInput
                            ...
                            autoFocus={true}
                            className={`form_input is-company-name is-light w-node-ddccfe64-6bfe-f12b-5b59-85ae90686f97-8e6c4fb0 ${_activeStyleVariant}`}
                          ...
                          <FormTextInput
                            ...
                            autoComplete={"url"}
                            autoFocus={true}
                            className={`form_input is-website is-light ${_activeStyleVariant}`}
                            data-name={"Website"}
                            disabled={false}
                            id={"Company-Website"}
                            maxLength={256}
                          ...
                          <FormTextarea
                            autoFocus={false}
                            className={`form_input is-text-area is-light ${_activeStyleVariant}`}
                            data-name={"Message"}
                            id={"Message"}
                            maxLength={5000}
                            name={"Message"}
                          ...
                          />
                          <FormButton
                            className={`component_button-size-variant ${_activeStyleVariant}`}
