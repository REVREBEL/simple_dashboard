...
export function SimpleContactForm({
  ...
  formId = "",
  paragraphText = "Tell us what you're working on — openings, transitions, distribution, or revenue strategy — and we’ll help you map the next move.",
  slotHeadline,
  submitButtonLoading = "Please wait...",
  text = "in-the-know",
  variant = "Light",
}) {
  const _styleVariantMap = {
    Light: "",
    Primary: "w-variant-42000863-b2a3-dd7b-2c89-fcca678991a6",
    Dark: "w-variant-6cd4aead-a271-b99a-0260-b87d589139e7",
    "Color 2": "w-variant-8be4fbb5-499e-4d58-1833-136ba160f540",
  };
  ...
  return (
    ...
    >
      <Section
        className={`simple-contact_wrapper ${_activeStyleVariant}`}
        grid={{
          type: "section",
        }}
        tag={"div"}
      >
        {eyebrowVisibility ? (
          <Block
            className={`simple-contact_eyebrow ${_activeStyleVariant}`}
            tag={"div"}
          >
            {eyebrowText}
          </Block>
        ...
        <Block
          className={`simple-contact_subheadline is-dark ${_activeStyleVariant}`}
          tag={"div"}
        >
          {text}
        </Block>
        <Block
          className={`is-max-width_800px margin-inline_auto ${_activeStyleVariant}`}
          tag={"div"}
        >
          {slotHeadline}
        </Block>
        <Block
          className={`simple-contact_text ${_activeStyleVariant}`}
          tag={"div"}
        >
          {paragraphText}
        </Block>
        <FormWrapper
          className={`simple-contact_form ${_activeStyleVariant}`}
          id={formId}
        >
          <FormForm
            className={`form_input-wrapper flex_horizontal flex-align_center position_relative flex-vercal_mobile-l flex-vertial_mobile-l ${_activeStyleVariant}`}
            data-name={"Simple Contact Form"}
            id={"wf-form-Simple-Contact-Form"}
            method={"get"}
            name={"wf-form-Simple-Contact-Form"}
          >
            <Block
              className={`form_input-container ${_activeStyleVariant}`}
              tag={"div"}
            >
              <HtmlEmbed
              ...
              <FormTextInput
                autoFocus={false}
                className={`form_input simple-contact_form ${_activeStyleVariant}`}
            ...
            <FormButton
              className={`submit-button simple-contact-button ${_activeStyleVariant}`}
