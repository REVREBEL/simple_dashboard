...
export function AuthorSection({
  ...
  return (
    ...
    >
      <Block className={"author_section text-color-primary"} tag={"div"}>
        <BlockContainer
          ...
          tag={"div"}
        >
          <Block className={"author_detail"} tag={"div"}>
            <Block className={"author_detail-wrapper"} tag={"div"}>
              <Block className={"author_main-image-wrapper"} tag={"div"}>
                <Image
                  className={"author_main-image"}
                  height={"auto"}
                  loading={"lazy"}
                  src={authorMetaAuthorImage}
                  width={"Auto"}
                />
              </Block>
              <Block className={"author_bio-wrapper"} tag={"div"}>
                <Block className={"author_meta-wrapper"} tag={"div"}>
                  <Block className={"flex_vertical gap-xs"} tag={"div"}>
                    <Block tag={"div"}>
                      {authorMetaSlotHeadline}
                      <Block className={"subheadline-xs"} tag={"div"}>
                        {
                          "Hospitality rebel with an affinity for innovative building strategies."
                        }
                      </Block>
                    </Block>
                    <Block className={"label"} tag={"div"}>
                      {authorMetaAuthorLocationText}
                    </Block>
                  </Block>
                  <Block className={"space-xs"} tag={"div"} />
                  <Paragraph className={"paragraph"}>
                    {authorMetaAuthorBioSummary}
                  </Paragraph>
                  <Block className={"author_contact-block"} tag={"div"}>
                    {authorMetaEmailVisibility ? (
                      <Link
                        block={"inline"}
                        button={false}
                        options={authorMetaEmailAddress}
                      >
                        <Block
                          className={
                            "text-size-base text-color-3 font-eyebrow font-weight-light"
                          }
                          tag={"div"}
                        >
                          {authorMetaEmailAddressText}
                        </Block>
                      </Link>
                    ) : null}
                    {authorMetaWebsiteVisibility ? (
                      <Link
                        block={"inline"}
                        button={false}
                        options={authorMetaWebsite}
                      >
                        <Block
                          className={
                            "text-size-base text-color-3 font-eyebrow font-weight-light"
                ...
                {socialsVisibility ? (
                  <Block
                    ...
                    id={"w-node-_0380558a-71c6-9d9d-3016-a9a1ff38af02-20b72182"}
                    tag={"div"}
                  >
                    <Grid
                      className={"flex_vertical gap-xxs"}
                      id={
                        "w-node-b861c6e6-6fcb-fa63-2516-ab3d20b7218f-20b72182"
                      }
                      tag={"div"}
                    >
                      <SocialsElement
