...
export function ArticleCard({
  ...
  const _styleVariantMap = {
    None: "",
    "0x1 Gap": "w-variant-1e889055-f177-28e9-b092-5f8c98f32bcf",
    "0x2 Gap": "w-variant-1e889055-f177-28e9-b092-5f8c98f32bd0",
    "0x3 Gap": "w-variant-1e889055-f177-28e9-b092-5f8c98f32bd1",
    "1x1 Gap": "w-variant-1e889055-f177-28e9-b092-5f8c98f32bd2",
    "1x2 Gap": "w-variant-1e889055-f177-28e9-b092-5f8c98f32bd3",
    "2x1 Gap": "w-variant-1e889055-f177-28e9-b092-5f8c98f32bd4",
    "2x2 Gap": "w-variant-1e889055-f177-28e9-b092-5f8c98f32bd5",
    "3x2 Gap": "w-variant-1e889055-f177-28e9-b092-5f8c98f32bd6",
    "3x3 Gap": "w-variant-1e889055-f177-28e9-b092-5f8c98f32bd7",
  };
  ...
  return (
    ...
    >
      <Block
        ...
        id={"w-node-_2a039039-99d6-a765-dfd7-42bb3c7d02b1-3c7d02b1"}
        tag={"div"}
      >
        <Block
          className={`c-card-body-wrapper radius-card_lg is-regular ${_activeStyleVariant}`}
          tag={"div"}
        >
          {conditional({
            rules: [
            ...
            <Block
              ...
              id={"w-node-_1c84cca6-e3c7-86a4-5027-5dc381cc773e-3c7d02b1"}
              tag={"div"}
            >
              <Image
                alt={
          ...
          {conditional({
            ...
            <Block
              className={`c-image-cover c-card_border-radius ${_activeStyleVariant}`}
              id={"w-node-_8c7d3121-2cc7-e56f-1a58-5bb891662f4e-3c7d02b1"}
              tag={"div"}
            >
              <Image
                alt={
          ...
          <Block
            className={`c-card-body text-primary padding-responsive-sm ${_activeStyleVariant}`}
            id={"w-node-_1c84cca6-e3c7-86a4-5027-5dc381cc7740-3c7d02b1"}
            tag={"div"}
          >
            <Block className={`c-gap-size ${_activeStyleVariant}`} tag={"div"}>
              ...
              >
                <Block
                  className={`slot_read-more ${_activeStyleVariant}`}
                  tag={"div"}
                >
                  {webflowComponentSlotsSlotReadMore}
                </Block>
                <Block
                  className={`slot_views-likes ${_activeStyleVariant}`}
                  tag={"div"}
                >
                  {webflowComponentSlotsSlotViewsLikes}
                </Block>
