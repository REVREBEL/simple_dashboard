  ...
  return (
    ...
    >
      <BlockContainer
        ...
        tag={"div"}
      >
        <Block className={"section padding-inline_md"} tag={"div"}>
          <Block
            className={"grid_2-col text-color-primary grid-blog-ads"}
            tag={"div"}
          >
            <Image
              className={"text-size-base"}
              height={"auto"}
              id={"w-node-_7556a3b6-7d94-4767-12ee-acc963814292-6381428f"}
              loading={"lazy"}
              src={image}
              width={"auto"}
            />
            <Block
              className={"blog-list_content-wrapper"}
              id={"w-node-_7556a3b6-7d94-4767-12ee-acc963814293-6381428f"}
              tag={"div"}
            >
              <Block
                className={
                  "item-wrapper flex-vertical height_100pct color-card_body"
                }
                id={"w-node-_7556a3b6-7d94-4767-12ee-acc963814294-6381428f"}
                tag={"div"}
              >
                <Block
                  className={"article_content-wrapper margin-bottom_sm"}
                  tag={"div"}
                >
                  <Block
                    className={"component_card-meta-wrapper flex-algin_stretch"}
                    tag={"div"}
                  >
                    {slotCardMeta}
                  </Block>
                  <Heading
                    className={
                      "headline-sm font-weight-semibold padding-top_xs padding-bottom_sm"
                    }
                    tag={"h3"}
                  >
                    {title}
                  </Heading>
                  <Paragraph className={"paragraph"}>{text}</Paragraph>
                </Block>
                <Block className={"card_item-wrapper"} tag={"div"}>
                  {slotReadMore}
                </Block>
                <Block className={"divider_opaque-50pct"} tag={"div"} />
              </Block>
            </Block>
          </Block>
        </Block>
